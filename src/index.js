...
function createObjects() {
	...
	createBox(new THREE.Vector3(0, -1.5, 0), quaternionRamp, 8, 4, 10, 0, null, true)
	...
	const loading = Promise.all(
		...
		createBuilding("red_building.3mf", { x: -16.1, y: 5, z: 15.5 }, { w: 23.7, l: 10, h: 23.5 }, ZERO_QUATERNION, wireframe),

		createBuilding("pink_building.3mf", { x: -16.3, y: 5, z: -17 }, { w: 23.7, l: 10, h: 23.5 }, ZERO_QUATERNION, wireframe),

		createBuilding("blue_building.3mf", { x: 16.3, y: 5, z: -21 }, { w: 23.7, l: 10, h: 15.8 }, ZERO_QUATERNION, wireframe),
		//carregando os caminhões e adicionando fisica
		createBoxPhysicsStatic({ x: -13, y: 1.5, z: 2.09 }, { w: 6.3, l: 3, h: 2.47 }, ZERO_QUATERNION, wireframe),

		createBoxPhysicsStatic({ x: -21, y: 1.5, z: 2.09 }, { w: 6.3, l: 3, h: 2.47 }, ZERO_QUATERNION, wireframe),

		createBoxPhysicsStatic({ x: -21, y: 1.5, z: 2.09 }, { w: 6.3, l: 3, h: 2.47 }, ZERO_QUATERNION, wireframe),


		createBoxPhysicsStatic({ x: -30.25, y: 1.5, z: 12.1 }, { w: 2.47, l: 3, h: 9.25 }, quaterniontruckYellow1, wireframe),

		createBoxPhysicsStatic({ x: -13.3, y: 1.5, z: 34.55 }, { w: 9.25, l: 3, h: 2.47 }, ZERO_QUATERNION, wireframe),


		createBoxPhysicsStatic({ x: 30.475, y: 1.5, z: 18.27 }, { w: 2.47, l: 3, h: 9.25 }, quaterniontruckYellow2, wireframe),


		createBoxPhysicsStatic({ x: 22.68, y: 1.5, z: -9 }, { w: 2.47, l: 3, h: 6.3 }, quaterniontruckBlue, wireframe),

		createBoxPhysicsStatic({ x: 35.26, y: 1.5, z: -15.7 }, { w: 2.5, l: 3, h: 6.3 }, ZERO_QUATERNION, wireframe),
		//carregando os carros e adicionando fisica
		createBoxPhysicsDynamic("car_orange1.3mf", { x: 16, y: 1.3, z: 29.57 }, { w: 5, l: 2.5, h: 2.4 }, ZERO_QUATERNION, 1500, 1, wireframe),

		createBoxPhysicsDynamic("car_orange2.3mf", { x: 7.5, y: 1.3, z: -10 }, { w: 2.4, l: 2.5, h: 5 }, ZERO_QUATERNION, 1500, 1, wireframe),


		createBoxPhysicsDynamic("car_yellow1.3mf", { x: 14, y: 1.3, z: -9 }, { w: 2.4, l: 2.5, h: 5 }, quaternionCarYellow1, 1500, 1, wireframe),


		createBoxPhysicsDynamic("car_yellow2.3mf", { x: -35, y: 1.3, z: -20 }, { w: 2.4, l: 2.5, h: 5 }, quaternionCarYellow2, 1500, 1, wireframe),


		createBoxPhysicsDynamic("car_blue.3mf", { x: -2.8, y: 1.3, z: -20 }, { w: 2.4, l: 2.5, h: 5 }, quaternionCarBlue, 500, 1, wireframe),
